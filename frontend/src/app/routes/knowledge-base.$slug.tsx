    ...
    <div className="mx-auto flex w-full max-w-6xl flex-1 flex-col gap-6 px-4 py-8">
      ...
      {isLoading ? (
        ...
        <div className="flex flex-col gap-6 lg:flex-row lg:items-start">
          <aside className="border-gray-blue w-full shrink-0 overflow-y-auto border p-3 lg:sticky lg:top-4 lg:max-h-[calc(100vh-6rem)] lg:w-80">
            <h2 className="text-pale-black mb-3 text-sm font-bold">{manual?.title}</h2>
